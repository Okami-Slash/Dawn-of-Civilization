...
iCivBabylonia :	Techs([]),
iCivAssyria :	Techs([iLeverage, iSmelting, iTanning, iPottery, iMining, iProperty, iMasonry, iAgriculture, iPastoralism]),
iCivIndia :	Techs([iLiterature, iContract, iBloomery], column=3, exceptions=[iSeafaring, iShipbuilding]),
iCivHittite :	Techs([iMasonry, iLeverage, iProperty, iArithmetics, iSmelting, iAlloys], column=1, exceptions=[iMythology, iSailing]),
...
iCivVikings : 	Techs([iNobility, iSteel, iArtisanry, iPolitics, iArchitecture, iGuilds], column=5, exceptions = [iPhilosophy]),
...
iCivChina :	Techs([iMachinery], column=6, exceptions=[iNobility, iPolitics, iEthics, iScholarship]),
iCivIndia :	Techs([iNobility, iSteel, iPolitics, iFeudalism], column=5, exceptions = [iEngineering, iAesthetics]),
iCivPolynesia :	Techs([iLiterature, iNavigation], column=3, exceptions=[iAlloys, iConstruction, iRiding]),
iCivEthiopia :	Techs(column=4, exceptions=[iBloomery, iMathematics]),
...
iCivKorea :	Techs(column=6, exceptions=[iNobility, iEthics, iArchitecture, iPolitics, iScholarship]),
},
{
