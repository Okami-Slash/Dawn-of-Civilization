...
iTamils, iEthiopia, iVietnam, iKorea, iMaya, iByzantium, iJapan, iVikings, iTurks, iArabia, iTibet, iIndonesia,
iMoors, iSpain, iFrance, iKhmer, iEngland, iHolyRome, iRussia, iPhilippines, iSwahili, iMamluks, iMali, iPoland, iZimbabwe, iPortugal, 
iInca, iItaly, iNigeria, iMongolia, iAztecs, iMughals, iOttomans, iThailand, iCongo, iSweden, iNetherlands, iManchuria,
...
pTamils, pEthiopia, pVietnam, pKorea, pMaya, pByzantium, pJapan, pVikings, pTurks, pArabia, pTibet, pIndonesia, 
pMoors, pSpain, pFrance, pKhmer, pEngland, pHolyRome, pRussia, pPhilippines, pSwahili, pMamluks, pMali, pPoland, pZimbabwe, pPortugal, 
pInca, pItaly, pNigeria, pMongolia, pAztecs, pMughals, pOttomans, pThailand, pCongo, pSweden, pNetherlands, pManchuria, 
...
teamInca, teamItaly, teamNigeria, teamMongolia, teamAztecs, teamMughals, teamOttomans, teamThailand, teamCongo, teamSweden, teamNetherlands, teamManchuria, 
...
lCivGroups = [[iGreece, iRome, iByzantium, iVikings, iMoors, iSpain, iFrance, iEngland, iHolyRome, iRussia, iNetherlands, iItaly, iPoland, iPortugal, iGermany, iSweden],  #Euros
		...
		[iEgypt, iBabylonia, iPersia, iByzantium, iArabia, iOttomans, iCarthage, iMamluks], #MiddleEastern
		[iEgypt, iGreece, iCarthage, iRome, iByzantium, iMoors, iTurks], #Mediterranean
...
lCivStabilityGroups = [[iVikings, iSpain, iFrance, iEngland, iHolyRome, iRussia, iNetherlands, iPoland, iPortugal, iItaly, iGermany, iSweden],  #Euros
		...
		[iBabylonia, iPersia, iArabia, iOttomans, iMughals, iMamluks, iTurks], #MiddleEastern
...
lTechGroups = [[iRome, iGreece, iByzantium, iVikings, iSpain, iFrance, iEngland, iHolyRome, iRussia, iNetherlands, iPoland, iPortugal, iItaly, iGermany, iAmerica, iArgentina, iBrazil, iCanada, iSweden, iAustralia, iBoers], #Europe and NA
	       [iEgypt, iBabylonia, iHarappa, iIndia, iCarthage, iPersia, iEthiopia, iArabia, iMoors, iMali, iOttomans, iMughals, iTamils, iCongo, iMamluks, iNigeria, iSwahili, iZimbabwe, iTurks], #Middle East
...
lCivBioOldWorld = [iEgypt, iIndia, iChina, iBabylonia, iHarappa, iGreece, iPolynesia, iPersia, iCarthage, iRome, iJapan, iTamils, 
		   iEthiopia, iKorea, iByzantium, iVikings, iTurks, iArabia, iTibet, iKhmer, iIndonesia, iMoors, iSpain, iFrance, iEngland, iHolyRome, iRussia, 
		   iNetherlands, iMali, iOttomans, iPoland, iPortugal, iItaly, iMongolia, iAmerica, iMughals, iThailand, iCongo, iGermany, iSweden,
...
[iIndia, iJapan, iVietnam, iKorea, iTurks, iTibet, iKhmer, iMongolia, iThailand, iManchuria, iPhilippines], #China
...
[iEgypt, iBabylonia, iGreece, iPersia, iArabia, iRussia, iMamluks, iOttomans, iTurks], #Byzantium
...
[iPersia, iCarthage, iEthiopia, iByzantium, iArabia, iMoors, iOttomans, iTurks, iEgypt], #Mamluks
...
[iIndia, iChina, iPersia, iJapan, iKorea, iTibet, iRussia, iOttomans, iManchuria, iTurks], #Mongolia
[iSpain, iInca, iAmerica], #Aztec
[iHarappa, iIndia, iPersia, iTamils, iTibet, iTurks], #Mughals
[iBabylonia, iGreece, iPersia, iByzantium, iRussia, iMongolia, iCarthage, iMamluks, iTurks], #Ottomans
...
iNumUnits = 217
(iLion, iBear, iPanther, iWolf, iRabbit, iSettler, iCityBuilder, iWorker, iAmericanPioneer, iPunjabiWorker, iLabourer, iMadeireiro, 
iScout, iExplorer,  iBandeirante, iSpy, iReligiousPersecutor, iJewishMissionary, iOrthodoxMissionary, iCatholicMissionary, iProtestantMissionary, iIslamicMissionary, iHinduMissionary, 
...
iSwordsman, iJaguar, iLegion, iGallicWarrior, iAucac, iShotelai, iHeavySwordsman, iSamurai, iHuscarl, iGhazi, iPombos, iSpearman, 
iHoplite, iSacredBand, iImmortal, iImpi, iHeavySpearman, iPikeman, iLandsknecht, iRozwiWarrior, iArquebusier, iTercio, iJanissary, iOromoWarrior, iQizilbash, 
iMohawk, iMusketman, iRedcoat, iKarolin, iFusilier, iMinuteman, iRifleman, iGrenadier, iRocketeer, iGrenzer, iAlbionLegion, iAntiTank, iInfantry, 
iDigger, iSamInfantry, iMobileSam, iMarine, iNavySeal, iParatrooper, iMechanizedInfantry, iArcher, iAsharittuBowman, iMedjay, 
iSkirmisher, iHolkan, iKelebolo, iLongbowman, iPatiyodha, iRattanArcher, iCrossbowman, iChokonu, iBalestriere, iChariot, iWarChariot, iHuluganni, 
iCidainh, iHorseman, iCompanion, iNumidianCavalry, iAsvaka, iCamelRider, iHorseArcher, iMangudai, iKhampa, iOghuz, iCamelArcher, iLancer, iRoyalMamluk, iVaru, iYanLifida, iSavaran, iMobileGuard, 
iFarari, iPistolier, iKeshik, iCataphract, iChangSuek, iGhulamWarrior, iCamelGunner, iCuirassier, iGendarme, iConquistador, iWingedHussar, iEightBanner, iMountedBrave, iMoorCamelGunner, iHussar, 
iLlanero, iDragoon, iGuard, iCossack, iGrenadierCavalry, iCavalry, iRural, iKommando, iWarElephant, iBallistaElephant, iAtlasElephant, iTank, iPanzer, 
iMainBattleTank, iGunship, iCatapult, iBallista,  iHwacha, iTrebuchet, iBombard, iSiegeElephant, iCannon, iArtillery, 
iMachineGun, iHowitzer, iMobileArtillery, iWorkboat, iGalley, iWaka, iBireme, iBalangay, iWarGalley, iHeavyGalley, iDromon, iLongship, iCog, iDharani, iGalleass, iDjong, iKobukson, iDhow, iLanternas,
iCaravel, iCarrack, iGalleon, iEastIndiaman, iPrivateer, iCorsair, iFrigate, 
iShipOfTheLine, iManOfWar, iIronclad, iTorpedoBoat, iCruiser, iTransport, iDestroyer, iCorvette, iBattleship, iMissileCruiser, iStealthDestroyer, 
iSubmarine, iNuclearSubmarine, iCarrier, iBiplane, iFighter, iZero, iJetFighter, iBomber, iStealthBomber, iGuidedMissile,
iDrone, iNuclearBomber, iICBM, iSatellite, iGreatProphet, iGreatArtist, iGreatScientist, iGreatMerchant, iGreatEngineer, iGreatStatesman, iGreatGeneral, iGreatSpy, iFemaleGreatProphet, 
...
# Buildings
iNumBuildings = 330
(iPalace, iBarracks, iIkhanda, iGranary, iTerrace, iSmokehouse, iKraal, iPaganTemple, iMonument, iZiara, iObelisk, iStele,
iCandi, iEdict, iMalae, iTotemPole, iWalls, iIya, iDun, iStable, iGer, iLibrary, iEdubba,
...
iMarket, iSouq, iForum, iGlassmaker, iJail, iSacrificialAltar, iDivan, iBath, iReservoir,
iHammam, iForge, iMint, iArtStudio, iCastle, iCitadel, iPharmacy, iApothecary, iAlchemist, iPostOffice, iTambo, iCaravanserai,
iWharf, iCoffeehouse, iSalon, iBank, iRiksbank, iPiaohao, iRoyalExchange, iConstabulary, iMountedPolice, iCustomsHouse, iImmigrationOffice, iFeitoria, iUniversity,
iSeowon, iGompa, iCivicSquare, iDinh, iRathaus, iSejmik, iSewer, iStarFort, iPlaas, iEstate, iMausoleum, iFazenda, 
iHacienda, iDrydock, iLevee, iDike, iObservatory, iWarehouse, iCourthouse, iFactory, iAssemblyPlant, iZaibatsu, 
iDistillery, iPark, iCoalPlant, iRailwayStation, iLaboratory, iResearchInstitute, iNewsPress, iIndustrialPark, iCinema, iHospital, iSupermarket, 
iColdStoragePlant, iPublicTransportation, iDepartmentStore, iMall, iBroadcastTower, iIntelligenceAgency, iElectricalGrid, iAirport, iBunker, iBombShelters, iHydroPlant, 
iSecurityBureau, iStadium, iContainerTerminal, iNuclearPlant, iSupercomputer, iHotel, iRecyclingCenter, iLogisticsCenter, iSolarPlant, iFiberNetwork, iAutomatedFactory, iVerticalFarm, iJewishTemple, iJewishCathedral, iJewishMonastery, iJewishShrine, 
...
iIronworks, iRedCross, iNationalPark, iCentralBank, iSpaceport,  iGreatSphinx, iPyramids, iOracle, iGreatWall, iIshtarGate, iTerracottaArmy, 
...
iMoaiStatues, iFlavianAmphitheatre, iAquaAppia, iAlKhazneh, iTempleOfKukulkan, iMachuPicchu, iGreatLibrary, iFloatingGardens, iGondeshapur, iJetavanaramaya, 
...
iBurjKhalifa, iHubbleSpaceTelescope, iChannelTunnel, iSkytree, iOrientalPearlTower, iDeltaWorks, iSpaceElevator, iLargeHadronCollider, iITER, iSydneyOpera, iGreatZimbabwe) = range(iNumBuildings)
...
iAminatu, iLapuLapu, iKruger, iMandela, iShirazi, iDawud, iBarghash, iTrung, iChieuHoang, iHoChiMinh, iRusvingo, 
iMutota, iKhosrow, iBumin, iTamerlane) = range(iNumLeaders)
