...
#define BEGIN_WONDERS				(173) // increment if normal building (not for wonders) is added
#define BEGIN_GREAT_WONDERS			(BEGIN_WONDERS+12)
#define NUM_BUILDINGS_PLAGUE		(250) // always increment when a building is added
